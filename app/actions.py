...
def sell():
  if request.method == 'GET':
    ...
    return render_template('/confirmation.html', action='sell', symbol=symbol, quantity=quantity, name=data['name'], total=total, formattedTotal=formattedTotal, price=price, remainder=remainder)
